...
me = Address("Gotthold Scholz","gotthold.scholz@lhm.klab.cc")
...
def createCalendar(start, end, anz):
    ...
    for i in range(anz):
        ...
        # cal.add_component(createEvent(datetime(2005,4,4,8,0,0,tzinfo=pytz.utc), datetime(2005,4,4,9,0,0,tzinfo=pytz.utc)))
...
cal = createCalendar(datetime(2005,1,1,0,0,0,tzinfo = pytz.timezone("Europe/Berlin")),
                     ...
                     10000)
print cal.to_ical()
saveCalender(cal, "/tmp/gotthold.scholz1000.ics")
